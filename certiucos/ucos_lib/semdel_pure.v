...
Lemma sem_ecb_wt_ex_prop :
  forall grp etbl v x v'21 v'23 mqls tcbls cnt x2 x3 v'42 ecbls tid petbl pegrp petbl_addr,
    Int.eq grp ($ 0) = false ->
    ...
    R_ECB_ETbl_P x
                 (V$OS_EVENT_TYPE_SEM
                   :: Vint32 grp
                   :: Vint32 cnt :: x2 :: x3 :: v'42 :: Vint32 pegrp :: petbl_addr :: nil,
                  etbl,petbl) tcbls ->
...
Lemma semdel_ecblist_ecbmod_get :
  forall v'53 v'33 v'34 v'36 v'57 i2 x5 x6 x7 v'45 v'38 petbl pegrp petbl_addr,
    ...
    ECBList_P (Vptr (v'57, Int.zero)) Vnull 
              (nil ++
                   ((V$OS_EVENT_TYPE_SEM :: V$0 :: Vint32 i2 :: x5 :: x6 :: x7 :: Vint32 pegrp :: petbl_addr ::  nil,
                     v'53,petbl) :: nil) ++ v'45) (nil ++ (DSem i2 :: nil) ++ v'38) v'33 v'34 ->
...
Proof.
  ...
  destruct Hex as (Hpetbl & absmq & mqls' & v' & Hv & Hej & Hmt & Hlp). (* add Hpetbl *)
  destruct absmq.
  destruct e; tryfalse.
  usimpl Hv.
  inverts Heq.
...
Proof.
  ...
  splits.
  destruct Hrh1.
  destruct H0 as (Hpostq1 & H0 & Hpostq2). (* new add *)
  splits.
  intros.
  heat.
  ...
  simpl in H3.
  tryfalse.
  do (* 3 *)4 eexists; split; try eapply ecbmod_get_join_get; eauto.
  (* new add about postq *)
  intros.
   assert (eid = y \/ eid <>y) by tauto.
  apply Hpostq2 in H1.
  ...
  rewrite H1 in Hjo.
  inverts Hjo.
  assert (Hnil: x2 = nil \/ x2 <> nil) by tauto.
  destruct Hnil. subst; simpl in H3; tryfalse.
  false.
  eapply Hneq; eauto.
  repeat eexists; eauto.
  eapply ecbmod_get_join_get; eauto.
  (* end of new add *)
  destruct Hrh2.
  splits.
  intros.
  ...
  (* new add *)
  destruct H0 as (H0 & How & Howp).
  eapply RH_TCBList_ECBList_MUTEX_OWNER_P_subset_hold; eauto.
Qed.  
...
Proof.
  ...
  simpl in H0.
  mytac.
  rename H1 into Hpetbl; rename H3 into H1. (* new add *)
  destruct a.
  destruct p. (* new add *)
  mytac.
  lets Hx : IHy1 H2 H4.
...
Lemma semdel_ecblist_ecbmod_get' :
  forall v'57 v'40 v'35 v'53 v'33 v'34 v'36 v'47 i2 x5 x6 x7 v'45 v'38 petbl pegrp petbl_addr,
    ...
    ECBList_P v'47 Vnull
              (v'40 ++
                    ((V$OS_EVENT_TYPE_SEM :: V$0 :: Vint32 i2 :: x5 :: x6 :: x7 :: Vint32 pegrp :: petbl_addr :: nil,
                      v'53,petbl) :: nil) ++ v'45) (v'35 ++ (DSem i2 :: nil) ++ v'38) v'33
              v'34 ->
    EcbMod.get v'33 (v'57, Int.zero) = Some (abssem i2, nil) /\
    exists vg vv vx,
...
Proof.
  ...
  auto.
  simpl in H0.
  destruct H0 as (qid & Heq & Heb & Hpb & Hex). (* add Hpb *)
...
Lemma upd_last_prop:
  forall v g x vl z petbl ,
    V_OSEventListPtr v = Some x ->
    vl = upd_last_ectrls ((v, g,petbl) :: nil) z ->
    exists v', vl = ((v', g,petbl) ::nil) /\ V_OSEventListPtr v' = Some z.
Proof.
  intros.
  unfolds in H.
...
Lemma R_ECB_upd_hold :
  forall x1 v v0 v'36 x8 petbl,
    R_ECB_ETbl_P x1 (v, v0,petbl) v'36 ->
    R_ECB_ETbl_P x1 (ifun_spec.update_nth val 5 v x8, v0,petbl) v'36.
Proof.
  introv Hr.
  unfolds in Hr.
  destruct Hr.
...
Proof.
  ...
  mytac.
  remember (upd_last_ectrls ((v0, v1, v) (* (v, v0) *) :: nil) x8) as vl.
  ...
  simpl.
  simpl in Hep.
  destruct Hep as (qid & Heq & Hr & Hpeb & Hex). (* add Hpeb *)
  destruct p. (* new add *)
