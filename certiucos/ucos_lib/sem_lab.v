...
Lemma AOSEvent_fold:
  forall s P losevent osevent etbl petbl letbl lpetbl egrp pegrp,
    s |= node losevent osevent OS_EVENT **
         AOSEventTbl letbl etbl ** 
         AOSPostEventTbl lpetbl petbl ** P ->
    id_addrval' losevent os_code_defs.OSEventTbl OS_EVENT = Some letbl ->
    V_OSEventGrp osevent = Some egrp ->
    RL_Tbl_Grp_P etbl egrp ->
    id_addrval' losevent os_code_defs.OSPostEventTbl OS_EVENT = Some lpetbl ->
    V_OSPostEventGrp osevent = Some pegrp ->
    RL_Tbl_Grp_P petbl pegrp ->
    s |= AOSEvent losevent osevent etbl petbl ** P.
  intros.
  unfold AOSEvent.
  sep pauto.
  eauto.
...
Lemma AEventNode_fold:
  forall s v osevent etbl petbl d P,
    s |= AOSEvent v osevent etbl petbl** 
         AEventData osevent d ** P ->
    s |= AEventNode v osevent etbl petbl d ** P.
  intros.
  unfold AEventNode.
  sep auto.
Qed.
