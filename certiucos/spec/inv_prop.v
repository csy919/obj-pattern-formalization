...
Proof.
  ...
  simpl in H; simpljoin; unfolds; auto.
  simpl in H; destruct a; destruct msgql; tryfalse; destruct p; simpl in H; simpljoin.
  unfolds; right; eauto.
Qed.
...
forall v,
 ...
 exists v1 v2 v3 v4 v5 v6 v7 v8, v = v1 :: v2 :: v3 :: v4 :: v5 :: v6 :: v7 :: v8 :: nil.
Proof.
  intros.
...
Lemma AOSEvent_osevent_eq :
  forall osevent osevent' etbl etbl' petbl petbl' l e e0 M1 M2 M i lo o1 o2 a,
    (e, e0, M1, i, lo, o1, a) |= AOSEvent l osevent etbl petbl  ->
    (e, e0, M2, i, lo, o2, a) |= AOSEvent l osevent' etbl' petbl' ->
    sub M1 M -> sub M2 M ->
...
Lemma AEventNode_osevent_eq :
  forall v osevent osevent' etbl etbl' petbl petbl' d d' e e0 M1 M2 M i lo o1 o2 a,
    (e, e0, M1, i, lo, o1, a) |= AEventNode v osevent etbl petbl d ->
    (e, e0, M2, i, lo, o2, a) |= AEventNode v osevent' etbl' petbl' d' ->
    sub M1 M -> sub M2 M ->
    struct_atom_val_eq osevent osevent' os_ucos_h.OS_EVENT.
Proof.
...
Proof.
  ...
  eapply Aarray_osabst_emp in H28; eauto; substs. (* new add *)
  
  lets Hx: IHeventl H34; substs. (* change H24 -> H34 *)
  clear - H7 H17 H27. (* add H27 *)
...
Lemma AOSEvent_osabst_emp :
  forall l osevent etbl petbl e e0 M i lo o a,
    (e, e0, M, i, lo, o, a) |= AOSEvent l osevent etbl petbl ->
    o = empabst.
Proof.
  unfold AOSEvent; intros.
  simpl_sat H; simpljoin1.
  ...
  unfold AOSPostEventTbl in H28.
  simpl_sat H28; simpljoin1.
  eapply Aarray_osabst_emp in H8.
  eapply Aarray_osabst_emp in H4.
  simpljoin1.
Qed.

Lemma AEventNode_osabst_emp :
  forall v osevent etbl petbl d e e0 M i lo o a,
    (e, e0, M, i, lo, o, a) |= AEventNode v osevent etbl petbl d ->
    o = empabst.
Proof.
  unfold AEventNode; intros.
  simpl_sat H; simpljoin1.
...
Proof.
  ...
  lets Hx1: Aarray_precise' H19 H30. (* H28 -> H30 *)
  ...
  assert(x = x4 (* /\ x4 = x10 /\ x3 = x9 *)). (* x2 -> x4 *)
  assert(sub x10 M) by mem_join_sub_solver. (* x8 -> x11 *)
  assert(sub x19 M) by mem_join_sub_solver. (* x15 -> x21 *)

  lets Hx: node_vl_eq H9 H12 H17 H20(* H13 H15 *).
...
(*   unfold V_OSPostEventGrp in H39, H55. (* new add *) *)
  ...
  { eapply struct_type_vallist_match_os_event in H31; simpljoin1; do 8 eexists; eauto. } (* H22 -> H31 *)
  assert(exists v1 v2 v3 v4 v5 v6 v7 v8, v = v1::v2::v3::v4::v5::v6::v7::v8::nil).
  { eapply struct_type_vallist_match_os_event; eauto; do 8 eexists; eauto. }
...
(*   destruct H17 as (Heq1 & Heq2 & Heq3); substs. *)
  ...
  lets Hx2: IHeventl (* H25 H34 *) H35 H48.
  simpljoin1; mem_eq_solver M.
  
  eapply ecbf_sllseg_osabst_emp in (* H25 *) H35.
  eapply ecbf_sllseg_osabst_emp in (* H34 *) H48.
  substs.
...
(*   clear - H10 H11. *)
 ...
 clear -H8 H13 H18.
  ...
  apply (H0 o).
 clear -H8 H13 H18 H28.
  unfold sub in *.
  geat.
  clear -H11 H15 H27 H41.
  unfold sub in *.
  geat.
Qed.
...
(*        sub o1 o -> sub o2 o -> M1 = M2 /\ o1 = o2). *)
(* Proof. *)
(*   intros eventl eventl' M1 M2 o1 o2 e e0 i l a H H0. *)
(*   eapply precise'2precise;eauto. *)
(*   eapply AOSEventFreeList_precise';eauto. *)
(* Qed. *)
...
Lemma osq_sll_precise :
  forall osql osql' head e e0 M1 M2 i l o1 o2 a,
    ...
    (forall (M : mem) ( o : osabst),
       ...
       sub o1 o -> sub o2 o -> M1 = M2 /\ o1 = o2).
Proof. 
  intros osql osql' head e e0 M1 M2 i l o1 o2 a H H0.
  eapply precise'2precise;eauto.
  eapply osq_sll_precise';eauto.
Qed.
...
Lemma AOSQFreeList_precise :
  forall osql osql' e e0 i l a M1 M2 o1 o2,
    ...
    (forall (M : mem) ( o : osabst),
       ...
       sub o1 o -> sub o2 o -> M1 = M2 /\ o1 = o2).
Proof.
  intros osql osql' e e0 i l a M1 M2 o1 o2 H H0.
  eapply precise'2precise;eauto.
  eapply AOSQFreeList_precise';eauto.
Qed.
...
Lemma qblkf_sll_precise :
  forall qblkl qblkl' head e e0 M1 M2 i l o1 o2 a,
    ...
    (forall (M : mem) ( o : osabst),
       ...
       sub o1 o -> sub o2 o -> M1 = M2 /\ o1 = o2).
Proof.
  intros qblkl qblkl' head e e0 M1 M2 i l o1 o2 a H H0.
  eapply precise'2precise;eauto.
  eapply qblkf_sll_precise';eauto.
Qed.
...
Lemma AOSQFreeBlk_precise :
  forall qblkl qblkl' e e0 i l a M1 M2 o1 o2,
    ...
    (forall (M : mem) ( o : osabst),
       ...
       sub o1 o -> sub o2 o -> M1 = M2 /\ o1 = o2).
Proof.
  intros qblkl qblkl' e e0 i l a M1 M2 o1 o2 H H0.
  eapply precise'2precise;eauto.
  eapply AOSQFreeBlk_precise';eauto.
Qed.
...
Lemma AOSEvent_precise' :
  forall l osevent osevent' etbl etbl' petbl petbl' e e0 M1 M2 i lo o1 o2 a,
    (e, e0, M1, i, lo, o1, a) |= AOSEvent l osevent etbl petbl ->
    (e, e0, M2, i, lo, o2, a) |= AOSEvent l osevent' etbl' petbl' ->
    (forall M : mem,
       sub M1 M -> sub M2 M -> M1 = M2) /\
...
Proof.
  unfold AOSEvent; intros.
  simpl_sat H; simpl_sat H0; simpljoin1.
  rewrite H14 in H66; inverts H66.
  rewrite H34 in H86; inverts H86.
  lets Hx1: node_precise' H56 H4.

   lets Hx2: AOSEventTbl_precise' H61 H9.
...
Lemma AOSQCtr_precise :
  forall l osq osq' e e0 M1 M2 i lo o1 o2 a,
    ...
    sub o1 o -> sub o2 o -> M1 = M2 /\ o1 = o2).
Proof.
  intros l osq osq' e e0 M1 M2 i lo o1 o2 a H H0.
  eapply precise'2precise;eauto.
  eapply AOSQCtr_precise';eauto.
Qed.
...
Lemma AOSQBlk_precise :
  forall l osqblk osqblk' msgtbl msgtbl' e e0 M1 M2 i lo o1 o2 a,
    ...
    sub o1 o -> sub o2 o -> M1 = M2 /\ o1 = o2).
Proof.
  intros l osqblk osqblk' msgtbl msgtbl' e e0 M1 M2 i lo o1 o2 a H H0.
  eapply precise'2precise;eauto.
  eapply AOSQBlk_precise';eauto.
Qed.
...
Lemma AMsgData_precise :
  forall l osq osq' osqblk osqblk' msgtbl msgtbl' e e0 M1 M2 i lo o1 o2 a,
    ...
    sub o1 o -> sub o2 o -> M1 = M2 /\ o1 = o2).
Proof.
  intros l osq osq' osqblk osqblk' msgtbl msgtbl' e e0 M1 M2 i lo o1 o2 a H H0.
  eapply precise'2precise;eauto.
...
Proof.
  unfold AEventData; intros.
  simpl in H1.
  assert(exists v1 v2 v3 v4 v5 v6 v7 v8, osevent = v1::v2::v3::v4::v5::v6::v7::v8::nil).
  eapply struct_type_vallist_match_os_event; eauto.
  assert(exists t1 t2 t3 t4 t5 t6 t7 t8, osevent' = t1::t2::t3::t4::t5::t6::t7::t8::nil).
  eapply struct_type_vallist_match_os_event; eauto.
  simpljoin1.
...
Lemma AEventNode_precise' :
  forall l osevent osevent' etbl etbl' petbl petbl' d d' e e0 M1 M2 i lo o1 o2 a,
    (e, e0, M1, i, lo, o1, a) |= AEventNode l osevent etbl petbl d ->
    (e, e0, M2, i, lo, o2, a) |= AEventNode l osevent' etbl' petbl' d' ->
    (forall M : mem,
       sub M1 M -> sub M2 M -> M1 = M2) /\
    (forall o : osabst,
       sub o1 o -> sub o2 o -> o1 = o2).
...
Proof.
  ...
  destruct ectrl'.
  simpl in H0; simpljoin1; auto.
  unfold evsllseg in H0; fold evsllseg in H0; destruct msgql'; tryfalse; destruct e1; destruct p.
  unfold AEventNode in H0; simpl in H0; simpljoin1; tryfalse.
  destruct ectrl'.
  simpl in H0; simpljoin1.
  unfold evsllseg in H; fold evsllseg in H; destruct msgql; tryfalse; destruct a; destruct p.
  unfold AEventNode in H; simpl in H; simpljoin1; tryfalse.
  
  unfold evsllseg in H, H0;  fold evsllseg in H, H0.
  destruct msgql; destruct msgql'; tryfalse; destruct a, e1, p ,p0.
  destruct H, H0;
    simpl_sat H; simpljoin1; simpl_sat H0; simpljoin1.
  
  simpljoin1; split; intros.
  assert(
      struct_atom_val_eq v1 v3 os_ucos_h.OS_EVENT /\
      struct_type_vallist_match os_ucos_h.OS_EVENT v1 /\
      struct_type_vallist_match os_ucos_h.OS_EVENT v3
    ).
  split.
  ...
  simpljoin1.
  simpl in H1.
  assert(exists v1' v2 v3 v4 v5 v6 v7 v8, v1 = v1'::v2::v3::v4::v5::v6::v7::v8::nil).
  eapply struct_type_vallist_match_os_event; eauto.
  assert(exists a1 a2 a3 a4 a5 a6 a7 a8, v3 = a1::a2::a3::a4::a5::a6::a7::a8::nil).
  eapply struct_type_vallist_match_os_event; eauto.
  simpljoin1.
...
Lemma AOSTCBPrioTbl_precise' :
  forall ptbl ptbl' rtbl rtbl' tcbls tcbls' vhold vhold' e e0 i l a M1 M2 o1 o2 ptls ptls',
    (e, e0, M1, i, l, o1, a) |= AOSTCBPrioTbl ptbl rtbl tcbls ptls vhold ->
    (e, e0, M2, i, l, o2, a) |= AOSTCBPrioTbl ptbl' rtbl' tcbls' ptls' vhold' ->
    (forall M : mem,
       sub M1 M -> sub M2 M -> M1 = M2) /\
    (forall o : osabst,
       sub o1 o -> sub o2 o -> o1 = o2).
Proof.
  ...
  simpl_sat H; simpl_sat H0; simpljoin1.
  simpl in H99, H49; simpljoin1. (* change H73,H36 -> H99,H49 *)
  rewrite H0 in H; inverts H.
  rewrite <- H2 in H7. (* change H6 -> H7 *)
  unfold addrval_to_addr in H7; destruct x61, x17; inverts H7. (* change H6 -> H7, x49 -> x61 *)
  assert(Int.repr (Int.unsigned i1) = Int.repr (Int.unsigned i0)).
  rewrite H5; auto.
  do 2 rewrite Int.repr_unsigned in H; substs.
  simpl in H94, H44; simpljoin1. (* change H68,H31 -> H94,H44 *)
  rewrite H4 in H; inverts H.
  simpljoin1; split; intros.
  simpl in H95, H45; simpljoin1. (* change H69,H32 -> H95,H45 *)
  assert(x55 = x11). (* change x6,x0 -> x55, x11 *)
  rewrite <- H7 in H11. (* change H6,H9 -> H7,H11 *)
  unfold addrval_to_addr in H11; destruct vhold, vhold'. (* change H9 -> H11 *)
  inverts H11. (* change H9 -> H11 *)
  assert(Int.repr (Int.unsigned i1) = Int.repr (Int.unsigned i2)).
  rewrite H13; auto. (* change H11 -> H13 *)
  do 2 rewrite Int.repr_unsigned in H8; substs. (* change H3 -> H8 *)
  eapply mapstoval_true_mem_eq with (M:=M); eauto; mem_join_sub_solver.
  substs.
  lets Hx: Aarray_precise' H100 H50; simpljoin1. (* change H74,H37 -> H100,H50 *)
  eapply eq_join_eq; eauto.
  apply H8 with (M:=M); mem_join_sub_solver. (* change H3 -> H8 *)
  simpl in H81,H31; simpljoin1. (* new add *)
  apply Aarray_osabst_emp in H100; apply Aarray_osabst_emp in H50; substs. (* change H74,H37 -> H100,H50 *)
  simpl in H95, H45; simpljoin1. (* change H69,H32 -> H95,H45 *)
  simpl in H81,H31; simpljoin1. (* new add *)
  lets Hx: osabst_sub_sig_eq H H5. (* new add *)
  rewrite Hx; auto. (* new add *)
Qed.
...
Proof.
  ...
  (* *)
  (*   destruct head. simpl in H, H0 . simpljoin1. *)
  (*    lets Hx: IHvl H11 H5. *)
  (*   simpljoin1; split; intros. *)
  (*   eapply eq_join_eq; eauto. *)
  (*   eapply mapstoval_true_mem_eq with (M:=M); eauto; mem_join_sub_solver. *)
...
(* Lemma dllsegevaux_mpeq:  *)
(*   forall tcbvl tcbvl' tcblh locmp locmp' ptrmp ptrmp' e e0 i l a M1 M2 o1 o2 M,  *)
(*     (e, e0, M1, i, l, o1, a) |= llsegevaux tcblh Vnull tcbvl locmp ptrmp V_OSTCBNext -> *)
(*     (e, e0, M2, i, l, o2, a) |= llsegevaux tcblh Vnull tcbvl' locmp' ptrmp' V_OSTCBNext ->   *)
(*     tcb_linked_list_same_next tcbvl tcbvl' -> *)
(*     (* (forall t locv, get locmp t = Some locv -> rule_type_val_match Tint8 locv = true) ->  *) *)
(*     (* (forall t ptrv, get ptrmp t = Some ptrv -> rule_type_val_match (Tptr OS_EVENT) ptrv = true) ->  *) *)
(*     (* (forall t locv, get locmp' t = Some locv -> rule_type_val_match Tint8 locv = true) ->  *) *)
(*     (* (forall t ptrv, get ptrmp' t = Some ptrv -> rule_type_val_match (Tptr OS_EVENT) ptrv = true) ->   *) *)
(*     sub M1 M -> *)
(*     sub M2 M ->  *)
...
(*   unfold llsegevaux in Hsat1, Hsat2. *)
(*   fold llsegevaux in Hsat1, Hsat2. *)
(*   sep destruct Hsat1. *)
(*   sep destruct Hsat2. *)
(*   simpl_sat Hsat1; simpl_sat Hsat2; simpljoin1. *)
(*   inverts H4. (*Vptr _ = Vptr _*) *)
...
(*   simp_mt Hnxt. *)
(*   destruct Hnxt. subst. *)
(*   unfold evaux_node in H14, H75. *)
(*   sep split in H14. sep split in H75.  *)
(*   simpl in H75. simpl in H14. simpljoin1. *)
(*   assert (Heq: x1 = x9 /\ x19 = x). *)
(*   { *)
(*     eapply mapstoval_false_rule_type_val_match_eq with (t:=Tint8) (M:=M); eauto. *)
(*     mem_join_sub_solver. mem_join_sub_solver. *)
(*   } *)
...
(*   destruct Heq. substs. *)
(*   simpl in H95. simpl in H24. simpljoin1.   *)
(*   assert (Heq: x3 = x11 /\ x47 = x31).  *)
(*   { *)
(*     eapply mapstoval_false_rule_type_val_match_eq with (t:=Tptr OS_EVENT) (M:=M); eauto. *)
(*     mem_join_sub_solver. mem_join_sub_solver.     *)
(*   } *)
(*   destruct Heq. substs. *)
(*   simpl in H53. simpl in H30. simpljoin1. *)
(*   assert (Heq: x4 = x12 /\ x48 = x32). *)
(*   { *)
(*     eapply mapstoval_false_rule_type_val_match_eq with (t:=Tptr OS_EVENT) (M:=M); eauto. *)
(*     mem_join_sub_solver. mem_join_sub_solver.    *)
(*   } *)
(*   lets H00: IHtcbvl H106 H45 H0.  *)
(*   assert (Heq0: x5 = x13 /\ x6 = x14).  *)
(*   { *)
(*     apply H00. clear H00. *)
(*     instantiate (1:=M). mem_join_sub_solver. *)
(*     mem_join_sub_solver. *)
...
(* Lemma dllsegevaux_vleq:  *)
(*   forall tcbvl tcbvl' tcblh locvl locvl' posvl posvl' ptrvl ptrvl' e e0 i l  a M1 M2 o1 o2 M, *)
(*     (e, e0, M1, i, l, o1, a) |= dllsegevaux tcblh Vnull tcbvl locvl posvl ptrvl V_OSTCBNext -> *)
(*     (e, e0, M2, i, l, o2, a) |= dllsegevaux tcblh Vnull tcbvl' locvl' posvl' ptrvl' V_OSTCBNext ->  *)
(*     tcb_linked_list_same_next tcbvl tcbvl' -> *)
(*     array_type_vallist_match Tint8 locvl -> *)
(*     array_type_vallist_match Tint8 posvl -> *)
(*     array_type_vallist_match Tint8 ptrvl -> *)
(*     array_type_vallist_match Tint8 locvl' -> *)
(*     array_type_vallist_match Tint8 posvl' -> *)
(*     array_type_vallist_match Tint8 ptrvl' -> *)
(*     sub M1 M -> *)
(*     sub M2 M ->  *)
(*     locvl = locvl' /\ posvl = posvl' /\ ptrvl = ptrvl'.  *)
(* Proof.  *)
(*   inductions tcbvl. *)
(*   introv Hsat1 Hsat2 Hnxt Hmt1 Hmt2 Hmt3 Hmt1' Hmt2' Hmt3'.  *)
(*   introv Hsub1 Hsub2. *)
(*   simpl in Hsat1. *)
(*   destruct locvl; destruct posvl; destruct ptrvl; tryfalse. *)
(*   destruct tcbvl'. *)
(*   simpl in Hsat2. *)
(*   destruct locvl'; destruct posvl'; destruct ptrvl'; tryfalse. *)
(*   splits; auto. *)
...
(*   simpl in Hnxt. *)
(*   rewrite H0 in Hnxt. rewrite H2 in Hnxt. *)
(*   destruct Hnxt. *)
(*   subst x2. *)
(*   simpl_sat Hsat1; simpl_sat Hsat2; simpljoin1. *)
(*   inverts H1. *)
  
(*   simpl in H24.  simpl in H9. *)
(*   simpljoin1. *)
(*   lets H00: mapstoval_false_rule_type_val_match_eq H3 H. *)
(*   simpl in Hmt1. simpl. destruct v0; try (destruct Hmt1; tryfalse). auto. *)
(*   simpl in Hmt1'. simpl. destruct v3; try (destruct Hmt1'; tryfalse). auto. *)
(*   assert (Hsub1': sub x8 M) by mem_join_sub_solver.  *)
(*   assert (Hsub2': sub x2 M) by mem_join_sub_solver.  *)
(*   lets H000: H00 Hsub1' Hsub2'. clear H00. *)
(*   destruct H000. substs. *)
(*   clear Hsub1' Hsub2'. *)

(*   simpl in H29. simpl in H14. *)
(*   simpljoin1. *)
(*   lets H00: mapstoval_false_rule_type_val_match_eq H7 H1. *)
(*   simpl in Hmt2. simpl. destruct v1; try (destruct Hmt2; tryfalse). auto. *)
(*   simpl in Hmt2'. simpl. destruct v4; try (destruct Hmt2'; tryfalse). auto. *)
(*   assert (Hsub1': sub x26 M) by mem_join_sub_solver.  *)
(*   assert (Hsub2': sub x14 M) by mem_join_sub_solver.    *)
(*   lets H000: H00 Hsub1' Hsub2'. clear H00. *)
(*   destruct H000. substs. *)
(*   clear Hsub1' Hsub2'. *)

(*   simpl in H34. simpl in H19. *)
(*   simpljoin1. *)
(*   lets H00: mapstoval_false_rule_type_val_match_eq H9 H5. *)
(*   simpl in Hmt3. simpl. destruct v2; try (destruct Hmt3; tryfalse). auto. *)
(*   simpl in Hmt3'. simpl. destruct v5; try (destruct Hmt3'; tryfalse). auto. *)
(*   assert (Hsub1': sub x32 M) by mem_join_sub_solver.  *)
(*   assert (Hsub2': sub x20 M) by mem_join_sub_solver.    *)
(*   lets H000: H00 Hsub1' Hsub2'. clear H00. *)
(*   destruct H000. substs. *)
(*   clear Hsub1' Hsub2'. *)
(*   cut (locvl = locvl' /\ posvl = posvl' /\ ptrvl = ptrvl'). *)
(*   intro Heqs. destructs Heqs. splits; congruence. *)

(*   lets H00: IHtcbvl H35 H20 H4. *)
(*   apply H00. *)
(*   clear H00. *)
(*   destructs Hmt1; auto. *)
(*   destructs Hmt2; auto. *)
...
(* Lemma tcbdllsegevaux_vl_eq:  *)
(*   forall tcbvl tcbvl' tcblh locvl locvl' posvl posvl' ptrvl ptrvl' e e0 i l a M1 M2 o1 o2 M, *)
(*     (e, e0, M1, i, l, o1, a) |= tcbdllsegevaux tcblh tcbvl locvl posvl ptrvl -> *)
(*     (e, e0, M2, i, l, o2, a) |= tcbdllsegevaux tcblh tcbvl' locvl' posvl' ptrvl' ->  *)
(*     tcb_linked_list_same_next tcbvl tcbvl' -> *)
(*     sub M1 M -> *)
(*     sub M2 M ->  *)
(*     locvl = locvl' /\ posvl = posvl' /\ ptrvl = ptrvl'.  *)
(* Proof. *)
(*   introv Hsat1 Hsat2 Hnxt Hsub1 Hsub2. *)
(*   unfold tcbdllsegevaux in *.  *)
(*   sep split in Hsat1. *)
(*   sep split in Hsat2. *)
(*   eapply dllsegevaux_vleq; eauto. *)
(* Qed.    *)
...
(* Lemma dllsegevaux_osabst_emp: *)
(*   forall tcbvl e e0 M i l o a tcblh locvl posvl ptrvl,  *)
(*     (e, e0, M, i, l, o, a) |= dllsegevaux tcblh Vnull tcbvl locvl posvl ptrvl V_OSTCBNext -> *)
(*     o = empabst. *)
(* Proof. *)
(*   inductions tcbvl. *)
(*   intros. *)
...
(*   sep split in H. *)
(*   simpl_sat H; simpljoin1. *)
(*   simpl in H5. simpl in H10. simpl in H15. *)
(*   simpljoin1. *)
(*   eapply IHtcbvl; eauto. *)
(* Qed.  *)
...
(* Lemma dllsegevaux_precise0:  *)
(*   forall tcbvl tcbvl' tcblh locvl locvl' posvl posvl' ptrvl ptrvl' e e0 i l  a M1 M2 o1 o2, *)
(*     (e, e0, M1, i, l, o1, a) |= dllsegevaux tcblh Vnull tcbvl locvl posvl ptrvl V_OSTCBNext -> *)
(*     (e, e0, M2, i, l, o2, a) |= dllsegevaux tcblh Vnull tcbvl' locvl' posvl' ptrvl' V_OSTCBNext ->   *)
(*     tcb_linked_list_same_next tcbvl tcbvl' -> *)
(*     array_type_vallist_match Tint8 locvl -> *)
...
(*   simpl in Hnxt. *)
(*   rewrite H0 in Hnxt. rewrite H2 in Hnxt. *)
(*   destruct Hnxt. subst x2. *)

(*   introv Hsub1 Hsub2.  *)
  
(*   simpl_sat Hsat1; simpl_sat Hsat2; simpljoin1.  *)

(*   simpl in H23. simpl in H8. *)
(*   simpljoin1. *)
(*   lets H00: mapstoval_false_rule_type_val_match_eq H4 H. *)
(*   simpl in Hmt1. simpl. destruct v0; try (destruct Hmt1; tryfalse). auto. *)
(*   simpl in Hmt1'. simpl. destruct v3; try (destruct Hmt1'; tryfalse). auto. *)
(*   assert (Hsub1': sub x7 M) by mem_join_sub_solver. *)
(*   assert (Hsub2': sub x M) by mem_join_sub_solver. *)
(*   lets H000: H00 Hsub1' Hsub2'. clear H00. *)
(*   destruct H000. substs.  *)
(*   clear Hsub1' Hsub2'. *)

(*   simpl in H28. simpl in H13. *)
(*   simpljoin1. *)
(*   lets H00: mapstoval_false_rule_type_val_match_eq H7 H1. *)
(*   simpl in Hmt2. simpl. destruct v1; try (destruct Hmt2; tryfalse). auto. *)
(*   simpl in Hmt2'. simpl. destruct v4; try (destruct Hmt2'; tryfalse). auto. *)
(*   assert (Hsub1': sub x25 M) by mem_join_sub_solver. *)
(*   assert (Hsub2': sub x13 M) by mem_join_sub_solver. *)
(*   lets H000: H00 Hsub1' Hsub2'. clear H00. *)
(*   destruct H000. substs.  *)
(*   clear Hsub1' Hsub2'. *)
  
(*   simpl in H33. simpl in H18. *)
(*   simpljoin1. *)
(*   lets H00: mapstoval_false_rule_type_val_match_eq H9 H6. *)
(*   simpl in Hmt3. simpl. destruct v2; try (destruct Hmt3; tryfalse). auto. *)
(*   simpl in Hmt3'. simpl. destruct v5; try (destruct Hmt3'; tryfalse). auto. *)
(*   assert (Hsub1': sub x31 M) by mem_join_sub_solver. *)
(*   assert (Hsub2': sub x19 M) by mem_join_sub_solver. *)
(*   lets H000: H00 Hsub1' Hsub2'. clear H00. *)
(*   destruct H000. substs.  *)
(*   clear Hsub1' Hsub2'. *)

(*   destruct Hmt1. destruct Hmt2. destruct Hmt3. *)
(*   destruct Hmt1'. destruct Hmt2'. destruct Hmt3'. *)
(*   lets H00: IHtcbvl H34 H19 H3. *)
(*   lets H000: H00 H11 H13 H16 H18. clear H00. *)
(*   lets H00: H000 H22 H24. clear H000. *)
(*   mem_eq_solver2. *)
(*   apply H00 with (M:=M); mem_join_sub_solver. *)
(* Qed.  *)

(* Lemma tcbdllsegevaux_precise': *)
(*   forall tcbvl1 tcbvl1' tcbvl2 tcbvl2' tcblh ctcb locmp locmp' ptrmp ptrmp' e e0 i l a M1 M2 o1 o2,   *)
(*     (e, e0, M1, i, l, o1, a) |= tcbllsegevaux tcblh ctcb tcbvl1 tcbvl2 locmp ptrmp -> *)
(*     (e, e0, M2, i, l, o2, a) |= tcbllsegevaux tcblh ctcb tcbvl1' tcbvl2' locmp' ptrmp' ->   *)
(*     tcb_linked_list_same_next tcbvl1 tcbvl1' ->  *)
(*     tcb_linked_list_same_next tcbvl2 tcbvl2' ->   *)
(*     (forall M, sub M1 M -> sub M2 M -> M1 = M2) /\ *)
(*     (forall o, sub o1 o -> sub o2 o -> o1 = o2). *)
(* Proof. *)
(*   introv Hsat1 Hsat2 Hnxt1 Hnxt2. *)
(*   unfold tcbllsegevaux in *. *)
(*   sep split in Hsat1. sep split in Hsat2. *)
(*   sep destruct Hsat1. sep destruct Hsat2. *)
(*   sep split in Hsat1. sep split in Hsat2. *)
(*   simpl_sat Hsat1; simpl_sat Hsat2; simpljoin1.  *)
(*   assert (Hemp1: x16 = empabst).   *)
(*   { eapply llsegevaux_osabst_emp in H13. auto. }  *)
(*   assert (Hemp2: x17 = empabst). *)
(*   { eapply llsegevaux_osabst_emp in H14. auto. } *)
(*   subst x16. subst x17. *)
(*   assert (Hemp1': x10 = empabst). *)
(*   { eapply llsegevaux_osabst_emp; eauto. } *)
(*   assert (Hemp2': x11 = empabst). *)
(*   { eapply llsegevaux_osabst_emp; eauto. } *)
(*   subst x10. subst x11.  *)
(*   split. *)
(*   2: { *)
(*     intros. mem_eq_solver2. *)
(*   } *)
(*   lets H01: llsegevaux_precise0 H13 H8 Hnxt1.  *)
(*   lets H02: llsegevaux_precise0 H14 H9 Hnxt2. *)
(*   intros. mem_eq_solver2. *)
(*   apply H01 with (M:=M); mem_join_sub_solver. *)
(*   apply H02 with (M:=M); mem_join_sub_solver. *)
(* Qed. *)
...
Proof.
  ...
  unfold OSInv in *.
  sep destruct H. sep destruct H0.
  (* do 23 destruct H, H0. (*从20修改成2*) *)
  sep remember (9::10::18::nil)%nat in H;
    sep remember (9::10::18::nil)%nat in H0.
  ...
  assert (
      forall (M: mem) (o0 : osabst),
        sub x49 M -> sub x43 M -> sub x52 o0 -> sub x46 o0 ->  
        x49 = x43 /\ x52 = x46 
    ).
  {
    clear H18 H13.
  ...
  assert (Hmoeq: x62 = x66 /\ x64 = x68).  (* x70 = x74 /\ x72 = x76 *)
  {
...
Ltac get_isr_is_prop H :=
  unfold OSInv in H; simpljoin1; do 22 destruct H; sep_rmb_trms_in H A_isr_is_prop; simpl in H; simpljoin1. 
(*do 20 改为 do 22 ,sep remember (19::nil)%nat 改成 sep remember (21::nil)%nat*)
(*22是之前exits的值，  20是不变式中结构数量*)
...
Lemma is_isr_AOSEvent :
  forall v osevent etbl petbl a b c ir ir' ie0 si si' cs0 x aop,
    (a, b, c, ir, (ie0, si, cs0), x, aop) |= AOSEvent v osevent etbl petbl ->
    (a, b, c, ir', (ie0, si', cs0), x, aop) |= AOSEvent v osevent etbl petbl.
Proof.
  unfold AOSEvent; intros.
  do 4 destr_and_inst H v.
  sep split in H; sep split; auto.
  simpl_sat H; simpl_sat_goal; simpljoin1.
  do 6 eexists; repeat (split; eauto).
  eapply is_isr_irrel_node; eauto.
  ...
  sep split in H14; sep split; auto.
  eapply is_isr_irrel_Aarray; eauto.
  
  unfold AOSPostEventTbl in *.
  sep split in H15; sep split; auto.
  eapply is_isr_irrel_Aarray; eauto.
Qed.
...
Lemma is_isr_AEventNode :
  forall v osevent etbl petbl d a b c ir ir' ie0 si si' cs0 x aop,
    (a, b, c, ir, (ie0, si, cs0), x, aop) |= AEventNode v osevent etbl petbl d ->
    (a, b, c, ir', (ie0, si', cs0), x, aop) |= AEventNode v osevent etbl petbl d.
Proof.
...
Proof.
  ...
  destruct ecbls; tryfalse; destruct a. destruct p.
  destr_and_inst H v.
  sep split in H; sep split; auto.
  simpl_sat H; simpl_sat_goal; simpljoin1.
  do 6 eexists; repeat (split; eauto).
...
(* Lemma is_isr_irrel_Aarray_half' : *)
(*   forall vl l n t a b c ir ir' ie0 si si' cs0 x aop, *)
(*     (a, b, c, ir, (ie0, si, cs0), x, aop) |= Aarray_halfpermission' l n t vl -> *)
(*     (a, b, c, ir', (ie0, si', cs0), x, aop) |= Aarray_halfpermission' l n t vl. *)
(* Proof. *)
(*   inductions vl; destruct n; intros. *)
(*   simpl in H; simpl;auto. *)
...
(* Lemma is_isr_irrel_Aarray_half : *)
(*   forall vl l t a b c ir ir' ie0 si si' cs0 x aop, *)
(*     (a, b, c, ir, (ie0, si, cs0), x, aop) |= Aarray_half l t vl -> *)
(*     (a, b, c, ir', (ie0, si', cs0), x, aop) |= Aarray_half l t vl. *)
(* Proof. *)
(*   unfold Aarray; intros. *)
(*   destruct t; tryfalse. *)
(*   eapply is_isr_irrel_Aarray_half'; eauto. *)
(* Qed. *)
...
Proof.
  unfold OSInv; intros.
  rename H0 into Hxxx.
  do 22 destr_and_inst H v. (*20改成22*)
  ...
  repeat (split; eauto).
  lets Hx : node_osabst_emp H7; substs. (* change H6 -> H7 *)
  
  eapply is_isr_irrel_node; eauto.
  
  do 6 eexists; repeat(split; eauto).
  eapply OSAbstMod.join_emp; auto.
  lets Hx: Aarray_osabst_emp H12; substs. (* change H11 -> H12 *)
...
Lemma GoodInvAsrt_AEventNode : forall v1 v2 v3 v4 v5,  GoodInvAsrt (AEventNode v1 v2 v3 v4 v5).
Proof.
  intros.
  ...
  apply GoodInvAsrt_Aarray.
  apply GoodInvAsrt_Aarray.
  unfold AEventData; destruct v5; try solve [simpl; auto].
...
Proof.
  ...
  apply GoodInvAsrt_Astruct.
  apply GoodInvAsrt_Aarray.
  apply GoodInvAsrt_Aarray. (* new add *)
Qed.

Lemma GoodInvAsrt_qblkf_sllseg: 
  forall vll hd tn t, GoodInvAsrt (qblkf_sllseg hd tn vll t V_nextblk). 
Proof.
  inductions vll.
  intros. simpl. auto.
...
Proof.
  ...
  split.
  simpl. auto.
  apply GoodInvAsrt_qblkf_sllseg.
  split.
  unfold AECBList.
  unfold GoodInvAsrt. fold GoodInvAsrt.
  intros. split; auto.
...
Proof.
  ...
  sep split in H10.
  sep_rmb_trms_in H10 (Astruct, flag_off, loc_off, ptr_off, sll, sllfreeflag).
  (* sep remember (7::8::3::4::5::6::9::10::nil)%nat in H10.   *)
  sep remember (7::nil)%nat in H10.
  (* sep remember (5::nil)%nat in H10. *)
  sep lift 2%nat in H10.
  simpl in H10; simpljoin1.
  sep remember (1::nil)%nat.
  simpl_sat_goal.
  exists (merge x15 Mx) x16 MM. 
  (* exists (merge x13 Mx) x14 MM. *)
  exists (merge x18 Ox) x19 OO.
  ...
  assert (
      (e, e0, merge x15 Mx, isr, st, merge x18 Ox, ab)
  ...
  sep remember (1::nil)%nat.
  simpl_sat_goal.
  exists Mx x15; eexists.
  exists Ox x18; eexists.
  splits; eauto.
  apply join_comm.
  ...
  substs.
  instantiate (1:=x23). instantiate (1:=x22).
  sep auto.
...
Proof.
  ...
  {
    sep_lifts_skp_in H2 ((OSTCBCur, _N_ 0), (OSTCBCur, _N_ 1)).
    sep remember (1::2::nil)%nat in H2. 
  ...
  sep remember (1::nil)%nat.
  simpl.
  exists x15 x23.  (* x15 x27 *)(*x19改为21*)
  do 4 eexists.
  splits; eauto.
  ...
  assert ((e, e0, M', isr, st, O, ab) |= 
            ...
            AOSTCBList'' x5 (Vptr ct) x7 (x8 :: x9) x10 ct x13 x17 ** H5). 
  substs.
  sep remember (1::nil)%nat.
  simpl.
  do 6 eexists.
