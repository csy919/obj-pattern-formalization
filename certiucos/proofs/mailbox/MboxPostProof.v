...
Proof.
  ...
  elim H0; intros.
  mauto_dbg.
  destruct H1; [rewrite H1 in *; simpl in H; inverts H; ur_rewriter; lia| ..].
  destruct H1; [rewrite H1 in *; simpl in H; inverts H; ur_rewriter; lia| ..].
  destruct H1; [rewrite H1 in *; simpl in H; inverts H; ur_rewriter; lia| ..].
  destruct H1; [rewrite H1 in *; simpl in H; inverts H; ur_rewriter; lia| ..].
  destruct H1; [rewrite H1 in *; simpl in H; inverts H; ur_rewriter; lia| ..].
  destruct H1; [rewrite H1 in *; simpl in H; inverts H; ur_rewriter; lia| ..].
  destruct H1; [rewrite H1 in *; simpl in H; inverts H; ur_rewriter; lia| ..].
  rewrite H1 in *; simpl in H; inverts H; ur_rewriter; lia.
...
Proof.
  ...
  destruct H0; intros.
  mauto_dbg.
  repeat (destruct H0;[subst x; unfold OSUnMapVallist in H; simpl in H; inverts H; ur_rewriter; lia| ..]).
  subst x; unfold OSUnMapVallist in H; simpl in H; inverts H; ur_rewriter; lia.
  assert ( 256 <= x)%nat by lia.
  clear H0.
...
(* ** ac:   SearchAbout (nth_val). *)
  ...
  rewrite math_shrl_3_eq; [idtac | clear -b1 b2; solve[lia | mauto] ..].
  rewrite math_8range_eqy;[idtac | clear -b1 b2; solve[lia | mauto] ..].
  unfolds.

  rewrite math_shrl_3_eq; [idtac | clear -b1 b2; solve[lia | mauto] ..].
  rewrite math_8range_eqy;[idtac | clear -b1 b2; solve[lia | mauto] ..].
  repeat tri_exists_and_solver1.
  clear -b1 b2; solve[lia | mauto].
  clear -b1 b2; solve[lia | mauto].
...
(* ** ac:   Print R_PrioTbl_P. *)
  ...
  rewrite math_shrl_3_eq in *; [idtac | clear -b1 b2; solve[lia | mauto] ..].
  rewrite math_8range_eqy in * ;[idtac | clear -b1 b2; solve[lia | mauto] ..].
