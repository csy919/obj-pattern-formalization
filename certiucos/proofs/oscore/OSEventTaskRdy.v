...
Proof.
  ...
  destruct Hsa.
  lets Hasd : math_nth_8_neq_not  H11 H18; try lia; eauto.
  split.
  split;
    intros.
  apply H19.
...
Proof.
  ...
  assert (0 = Int.unsigned x \/ 0 < Int.unsigned x) by lia.
  destruct H0; auto.
  false.
  apply Hps.
  rewrite H0.
...
Lemma PrioWaitInQ_RLH_ECB_ETbl_P_tcbls_ex :
  forall prio osevent etbl petbl l tcbls te d,
    PrioWaitInQ prio etbl ->
    V_OSEventType osevent = Some (Vint32 te) ->
    rel_edata_etype d te ->
    RLH_ECB_ETbl_P l (osevent,etbl, petbl) tcbls ->
...
Proof.
  ...
  lets Hzzps :  math_nth_8_eq_zero'  H13 H29 H28; eauto; try lia.
...
(*get the conditions used by following reasoning steps first*)
  ...
  lets Hx1: osunmapvallist_prop H19; simpljoin.
  ...
  lets Hx3: osunmapvallist_prop H27; simpljoin.
  apply Zle_bool_imp_le in H29.
  lets Hx4: osmapvallist_prop H11.
  lets Hx5: osmapvallist_prop H29.
  simp join.
  exists x5 x x3 x6 x7.
  splits; eauto.
  clear - H11; int auto.
  clear - H27; int auto.
  clear H27 H28 H30 H32.

  eapply rl_tbl_grp_neq_zero with (v'12:= egrp); eauto.
  int auto.
  clear - H29; int auto.
...
(**)
  ...
  hoare forward.
  rewrite y_ble_max; auto.
  rewrite update_nth_val_len_eq; rewrite H18; simpl; auto.
  ...
  apply disj_combine with (S:=(
   EX egrp',
     [| RL_Tbl_Grp_P (update_nth_val (Z.to_nat (Int.unsigned y)) etbl
      ...
      <|| v'19 ||> **
      LV ptr @ os_ucos_h.OS_EVENT ∗ |-> Vptr (v'29, Int.zero) **
      Astruct (v'29, Int.zero) os_ucos_h.OS_EVENT
        (Vint32 i1 :: Vint32 egrp' :: Vint32 i2 :: x0 :: x1 :: x2:: Vint32 i :: x4 :: nil) **
      Aarray v'25 (Tarray Int8u ∘OS_EVENT_TBL_SIZE)
      ...
      A_isr_is_prop **
      AEventData
        (Vint32 i1 :: Vint32 egrp :: Vint32 i2 :: x0 :: x1 :: x2:: Vint32 i :: x4 :: nil) v'18 **
      ...
      tcbdllseg v'20 v'21 v'22 v'23 v'12 **
      AOSPostEventTbl v'27 v'17 **
      p_local OSLInv ct (logic_val (V$ 1) :: v'24) **
  ...
  clear - H13 H22 H23 H18 y_lt8.
  simpl val_inj in *.
  assert(Int.unsigned y < Z.of_nat (length etbl)).
  rewrite H18; int auto.
  ...
  clear - x_lt8; int auto.
  clear - H27 y_lt8 H18.
  simpl val_inj in H27.
  rewrite len_lt_update_get_eq in *.
  simpl val_eq in H27.
  destruct (Int.eq (erow&ᵢInt.not bitx) ($ 0)) eqn : eq1; auto.
  destruct H27; simpl in H; tryfalse.
  rewrite H18; unfold OS_EVENT_TBL_SIZE; simpl; auto.
  ...
  apply hoare_pure_gen with (p:=(rel_edata_etype v'18 i1)).
  intros.
  clear - H11.
  unfold AEventData in H11.
  destruct v'18; sep split in H11; unfolds in H; simpl in H; inverts H; simpl; auto.
  ...
  assert(exists tid st m, get tcbls tid = Some ((y<<ᵢ$ 3)+ᵢx, st, m) /\ rel_edata_stat (v'29, Int.zero) v'18 st) as ex_tid_prio_rel.
  ...
  rename v'20 into head; rename v'21 into headprev;
  rename v'22 into tail; rename v'23 into tailnext.
(*   rename v'19 into head; rename v'20 into headprev;
  ...
  clear - y_lt8.
  lia.
  pose proof z_le_7_imp_n y H44.
  lets Hx: array_int8u_nth_lt_len H27.
  rewrite H43 in Hx.
  unfold OS_RDY_TBL_SIZE in Hx.
  lets Hx': Hx H45; clear Hx.
  auto.
  ...
  lets Hx: rl_tbl_grp_p_set_hold' H20 H19 H9 H18 H27.
  lets Hx1: Hx H43 unmap_egrp H44 nth_val_etbl H46; clear Hx.
  lets Hx2: Hx1 unmap_erow H45 nth_val_ptbl map_x bitx_le128; clear Hx1.
  lets Hx3: Hx2 map_y bity_le128 H14 H41; clear Hx2.
(*   lets Hx: rl_tbl_grp_p_set_hold' H17 H16 H9 H15 H23.
  ...
  hoare forward.
  pure_auto.
  rewrite H43; unfold OS_RDY_TBL_SIZE; simpl; auto.
...
{
  lets Hx: rl_rtbl_priotbl_p_hold tid_neq_vhold H4 H20 H19 H9.
  lets Hx' : Hx H18 H27 H43 unmap_egrp nth_val_etbl; clear Hx.
  clear - y_lt8; int auto.
...
{
  clear - H42 rl_tbl_grp_new prio_in_tbl_preserv y_lt8 x_lt8 map_x x_lt8 nth_val_rtbl.
...
eauto.
{
  lets Hx: TCBList_P_get_node_TCBNode_P H7 H26 tcbls_tid_prio.
  clear - Hx rel_ed_st.
