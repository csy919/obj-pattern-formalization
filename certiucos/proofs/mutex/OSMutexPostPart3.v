...
(* ** ac:     SearchAbout eq_dllflag. *)
    ...
    clear -H10 ; change (two_power_nat 16) with 65536; lia.
    clear ; change (two_power_nat 16) with 65536; lia.
    
    change (two_power_nat 16) with 65536 in *.
    clear -H102; repeat ur_rewriter; try lia.
    ...
    remember (   Int.unsigned (Int.or x ($ OS_MUTEX_AVAILABLE))) ; lia.
    go.
