...
(**************************** simplify begin ****************************)
  ...
  {
    eapply OSTimeDlyPure.low_stat_rdy_imp_high with (rtbl:=os_rdy_tbl); try eapply H17; eauto.
  }
  subst xs.
