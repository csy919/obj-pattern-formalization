...
Lemma good_frm_AOSPostEventTbl : 
  forall x0 v0, GoodFrm (AOSPostEventTbl x0 v0).
Proof.
  intros.
...
Hint Resolve good_frm_AOSPostEventTbl  : good_frm_lemmas.
...
Lemma good_frm_AOSEvent : 
  forall a0 v x petbl, GoodFrm  (AOSEvent a0 v x petbl).
Proof.
  intros.
  unfold AOSEvent.
  good_frm_sovler.
...
Lemma good_frm_amsgnode : 
  forall p a  b  v1 v2 v3 l petbl, 
    GoodFrm (AEventNode p a b petbl (DMsgQ l v1 v2 v3)).
Proof.
  introv.
  unfold AEventNode.
  unfold AEventData.
...
Lemma good_frm_AOSTCBPrioTbl:  forall  ptbl rtbl tcbls ptls vhold,
...
Lemma can_change_aop_aosposteventtbl:
  forall x d,
  can_change_aop (AOSPostEventTbl x d).
Proof.
  intros.
  unfold AOSPostEventTbl.
  can_change_aop_solver.
...
Hint Resolve can_change_aop_aosposteventtbl : can_change_aop.


Lemma  can_change_aop_aosevent:
  forall l vl etbl petbl,
   can_change_aop (AOSEvent l vl etbl petbl).
Proof.
  intros.
  unfold AOSEvent.
  can_change_aop_solver.
...
Theorem can_change_aop_msgqnode :
  forall l vl d petbl c,
    can_change_aop (AEventNode l vl d petbl c).
Proof.
  intros.
  unfold AEventNode.
  can_change_aop_solver.
