...
Proof.
  ...
  2:lets H1000:Int.unsigned_range x;lia.
  Focus 2.
  ...
  2:lets H100:Int.unsigned_range x;lia.
  assert (i=Int.add i0
                    (Int.mul (Int.repr (Z.of_nat (typelen t)))
  ...
  eapply ge0_z_nat_le;eauto.
  lets H1000:Int.unsigned_range x;lia.
  rewrite <- Zabs2Nat.abs_nat_nonneg at 1.
  eapply nth_val_imp_nth_val'_1;eauto.
  lets H1000:Int.unsigned_range x.
  lia.
...
Proof.
  ...
  intro H100.
  eapply assign_rule_deref_array_elem_aop''; eauto.
  apply Int_modu_to_Z_mod; auto || lia.
  rewrite <- H100; auto.
  rewrite <- H100; auto.
  rewrite <- H100; auto.
      ...
      match find_aop P with
        ...
        | some ?a =>
          hoare lift a pre;
            ...
            | simpl; auto
            | simpl; try lia
            | try (simpl typelen;simpl Z.of_nat);try lia
            | try (simpl typelen;simpl Z.of_nat);try lia
            | try (simpl typelen;simpl Z.of_nat);try lia
            | symbolic execution
            | simpl; try lia
